-- -- 添加索引
-- DROP PROCEDURE IF EXISTS ifaas_authority.add_index;
-- DELIMITER $$
...
--
-- -- 添加字段
-- DROP PROCEDURE IF EXISTS ifaas_authority.addFieldIfNotExists;
-- DELIMITER $$
...
--
-- -- 添加
-- DROP PROCEDURE IF EXISTS ifaas_authority.addSequence;
-- DELIMITER $$
...
--
-- -- 删除索引
-- DROP PROCEDURE IF EXISTS ifaas_authority.delete_index;
-- DELIMITER $$
...
--
-- -- 删除字段
-- DROP PROCEDURE IF EXISTS ifaas_authority.deleteFieldIfExists;
-- DELIMITER $$
...
--
-- -- 重命名表
-- DROP PROCEDURE IF EXISTS ifaas_authority.rename_table;
-- DELIMITER $$
...
--
-- -- 更新字段
-- DROP PROCEDURE IF EXISTS ifaas_authority.updateFieldAttribute;
-- DELIMITER $$
...
--
-- -- 更新字段值
-- DROP PROCEDURE IF EXISTS ifaas_authority.updateFieldValues;
-- DELIMITER $$
...
--
-- -- 创建添加唯一索引的存储过程
-- DROP PROCEDURE IF EXISTS ifaas_authority.add_unique_index;
-- DELIMITER $$
--
-- CREATE DEFINER=`ifaas_authority`@`%` PROCEDURE `add_unique_index`(IN dbname varchar(100), IN tablename varchar(100), IN indexname varchar(100), IN columnname varchar(100))
-- BEGIN
--
-- 	set @exist := (SELECT count(*) FROM INFORMATION_SCHEMA.STATISTICS WHERE TABLE_SCHEMA = dbname AND TABLE_NAME = tablename AND INDEX_NAME = indexname);
