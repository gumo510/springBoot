package com.gumo.demo.utils.encryptUtils.sm4;
...
public class SM4Utils {
    private String secretKey = "intellifLG";
    ...
    private static String strEncode (String value,String key) throws IOException {
    ...
    private static String strDecode (String value,String key) throws IOException {
    ...
    public static String encrypt (String value) throws BusinessException {
        ...
        try {
            value = value.trim();
            return strEncode(value, defaultKey);
        } catch (Exception e) {
            throw new BusinessException(CommonResultCodeEnum.DATA_DES_ERROR);
        }
    }

    public static String decrypt (String value) throws BusinessException {
        if(StringUtils.isBlank(value)){
            return null;
        }
        try {
            value = value.trim();
            return strDecode(value, defaultKey);
        } catch (Exception e) {
            throw new BusinessException(CommonResultCodeEnum.DATA_DES_ERROR);
        }
    }
